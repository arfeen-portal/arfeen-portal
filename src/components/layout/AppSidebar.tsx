...

 {
...

  {
    ...
    children: [
      ...
      { label: "Operations Live Control", href: "/operations/live-control" },
    ],
  },
...

  {
    ...
    children: [
      ...
      { label: "White Label Themes", href: "/admin/white-label-themes" },
      { label: "Domain Mapping", href: "/admin/domain-mapping" },
